...
export default function SanctumBg({
    ...
    const stars = [
        { top: "14%", left: "8%", angle: -12, delay: 14, duration: 1.4 },
        { top: "26%", left: "70%", angle: -18, delay: 22, duration: 1.6 },
        { top: "40%", left: "15%", angle: -10, delay: 28, duration: 1.5 },
        { top: "9%", left: "40%", angle: -20, delay: 35, duration: 1.7 },
    ];
