...
import { user, session, account, verification, organization as orgSchema, member, invitation, twoFactor as tfSchema, passkey as passSchema, apiKey as apiKeySchema } from "../schemas/auth-schema";
...
export const auth = betterAuth({
	...
	plugins: [
		...
		bearer(),
		admin({
			adminUserIds: ["6HMR9AtnWvEvf6AVkIRuEKGVda2azYZo"],
		}),
		multiSession(),
		oAuthProxy(),
		nextCookies(),
